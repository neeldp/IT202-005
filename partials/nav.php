...
<nav>
    <ul>
        <?php if (is_logged_in()) : ?>
            ...
            <li><a href="<?php echo get_url('competition_history.php'); ?>">Competition History</a></li>
        <?php endif; ?>
        <?php if (!is_logged_in()) : ?>
        ...
        <?php if (has_role("Admin")) :?>
            ...
            <li><a href="<?php echo get_url('admin/payout.php'); ?>">Payout</a></li>
            <li><a href="<?php echo get_url('admin/edit_comp.php'); ?>">Edit Competitions</a></li>
        <?php endif; ?>
        <?php if (is_logged_in()) : ?>
